...
void H_LCD_void_Init(void)
{
	...
	//set direction D3 .. D0
	M_DIO_void_setPinDir(LCD_D3_PORT,LCD_D3_PIN,OUT_2MHZ_PP);
	M_DIO_void_setPinDir(LCD_D2_PORT,LCD_D2_PIN,OUT_2MHZ_PP);
	M_DIO_void_setPinDir(LCD_D1_PORT,LCD_D1_PIN,OUT_2MHZ_PP);
	M_DIO_void_setPinDir(LCD_D0_PORT,LCD_D0_PIN,OUT_2MHZ_PP);
#endif
